 ...
 * Return: the value
 */
char *_fgetenv(finfo_a135 *finfo, const char *name)
{
 ...
 *  Return: Always 0
 */
int _fmsetenv(finfo_a135 *finfo)
{
	if ((*finfo).argc != 3)
	{
 ...
 *  Return: Always 0
 */
int _funsetenv(finfo_a135 *finfo)
{
	int i;
 ...
 * Return: Always 0
 */
int fpop_env_list(finfo_a135 *finfo)
{
	list_t *node = NULL;
	size_t i;
