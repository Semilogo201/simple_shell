 ...
 * Return: the value
 */
char *_fgetenv(finfo_a15 *finfo, const char *name)
{
 ...
 *  Return: Always 0
 */
int _funsetenv(finfo_a15 *finfo)
{
	int i;
 ...
 * Return: Always 0
 */
int fpop_env_list(finfo_a15 *finfo)
{
	list_t *node = NULL;
	size_t i;
